...
chuẩn hóa prefix DB ngày 25/05. Tham chiếu: [`10-bv103-implementation-mapping.md`](../10-bv103-implementation-mapping.md),
...
|------|----------|------------|--------|
| 1 | Đồng bộ doc mapping `10-bv103-implementation-mapping.md` theo prefix mới + cảnh báo Double SSOT | ✅ Done | Phụ lục "Prefix map 25/05/2026" + changelog 2026-05-25 |
...
| **A.4 Benchmark thực tế** | ✅ Done | `docs/specs/working/admin-module-perf-baseline-20260526.md` + `scripts/sql/admin-perf-baseline.sql`; tóm tắt: RPC stats 18.1ms, audit list 0.28ms, audit filter 0.16ms, table_choices 0.31ms — đúng 4 index mới được planner sử dụng |
