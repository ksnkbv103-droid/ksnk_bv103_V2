...
Trên UI: bật/tắt từng câu (ON/OFF) và **Sửa nhanh**.
...
| Cấu hình | `thi_thu_muc_do`: số câu, phút, **tỷ lệ Bloom** (admin) | `thi_that`: số câu, phút, điểm đạt, số lần, đảo câu/ĐA, chủ đề, gán khoa+NV |
| Kết quả | Ôn tập | Sổ quản trị |

Publish kỳ thật **bắt buộc** đã gán ít nhất một khoa hoặc NV.
