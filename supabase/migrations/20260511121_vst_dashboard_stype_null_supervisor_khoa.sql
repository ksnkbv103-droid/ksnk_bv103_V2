-- VST dashboard: stype khi mdm_nhan_su.khoa_id NULL (import legacy / seed) vẫn rơi ELSE 'CHEO'.
-- Nghiệp vụ BV103: người giám sát VST là đội KSNK; thiếu FK khoa trên nhân sự không được hiểu là "chéo".
