-- AI-F1: rpc_dashboard_vst_strategic_analytics — single-pass filtered CTEs (MATERIALIZED)
-- Reduces repeated scans of live summary views (post D-07). Output shape unchanged.
...
COMMENT ON FUNCTION public.rpc_dashboard_vst_strategic_analytics(date, date, uuid[], uuid[], uuid[], uuid[], text[])
  IS 'VST strategic dashboard — CTE MATERIALIZED filter (2026-06-09 perf).';
