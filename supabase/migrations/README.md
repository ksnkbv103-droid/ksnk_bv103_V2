...
Thư mục gốc giữ **25 migration** `20260530000000` … `20260602180000` + migration mới (vd. `20260602190000`).  
Remote đã apply chain cũ → **không** để file squash `20260602100000` ở đây (nằm `archive_legacy/20260602100000_init_pilot_baseline.sql`).
