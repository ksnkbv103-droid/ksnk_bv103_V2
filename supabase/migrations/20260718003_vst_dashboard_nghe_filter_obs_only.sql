-- Hotfix: lọc nghe chỉ trên fact_giam_sat_vst (phiên VST không có nghe_nghiep_id).
-- VST dashboard RPC: dùng nghe_nghiep_id sau migration 20260716013 (DROP text nghe_nghiep).
-- Sửa lỗi runtime: column d.nghe_nghiep does not exist → dashboard Command Center toàn 0.
