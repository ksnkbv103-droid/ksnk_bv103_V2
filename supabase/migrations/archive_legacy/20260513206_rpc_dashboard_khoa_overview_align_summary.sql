-- Command Center: rpc_get_dashboard_khoa_overview_rows — khớp phân loại TGS/KSNK/chéo và lọc phiên với rpc_get_dashboard_summary_table;
-- GSC: gom theo COALESCE(s.khoa_id, ns.khoa_id) khi s.khoa_id null (phiên vẫn vào tổng thẻ pie).
