-- Nguồn đếm 5 mốc WHO tách từ thoi_diem (độc lập với phiên bản rpc_get_vst_dashboard_v2 trên server).
-- App gọi song song và luôn dùng kết quả này cho by_moment_table → tránh dashboard cũ làm mất n_dat / tách sai dấu phẩy.
