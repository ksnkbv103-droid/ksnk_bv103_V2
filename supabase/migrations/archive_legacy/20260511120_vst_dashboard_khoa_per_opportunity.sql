-- Đếm / lọc VST dashboard theo khoa **trên từng cơ hội** (fact), không chỉ khoa phiên.
-- Tránh phình số khi phiên gắn B20 nhưng có thêm fact không thuộc B20 (nhập tay, lệch FK, v.v.).
