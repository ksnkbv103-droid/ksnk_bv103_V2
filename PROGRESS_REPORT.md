...
## 3) Trạng thái thực tế repo (route đã có — 11/05/2026)
...
| Quản lý công việc | `/quan-ly-cong-viec` | Module tác vụ |
...
| **S7** | **Công việc** | Giao việc → cập nhật → đóng trong pilot | Đang harden action/UI |
...
- **Công việc / Quản trị:** CRUD + quyền + import tối thiểu theo pilot.
