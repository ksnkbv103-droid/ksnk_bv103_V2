...
export default function DashboardPage() {
  ...
  // 1. TỔNG HỢP SỐ LIỆU TỪ SUMMARY TABLE ĐỂ VẼ BIỂU ĐỒ OVERVIEW CHUẨN XÁC
      ...
      <div className="app-data-shell">
        {activeTab === "overview" && (
          <div className="space-y-8">
            {/* Pie Chart & Bảng Xếp hạng Khoa (Lấy từ sources tổng hợp) */}
        ...
        {/* Tab Chuyên trách, Chéo, Tự giám sát hiện Dashboards RIÊNG BIỆT */}
