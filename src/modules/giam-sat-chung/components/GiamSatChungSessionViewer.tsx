...
export default function GiamSatChungSessionViewer({
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex touch-manipulation items-end justify-center bg-black/45 p-0 sm:items-center sm:p-4"
      role="dialog"
      aria-modal="true"
      aria-labelledby="gsc-viewer-title"
    >
      <div className="flex max-h-[min(92dvh,720px)] w-full max-w-3xl flex-col overflow-hidden rounded-t-2xl border border-slate-200 bg-white shadow-xl sm:rounded-[var(--radius-shell)]">
