    ...
    <header className="flex flex-col gap-4 rounded-2xl border border-slate-100 border-l-4 border-l-[#026f17] bg-white p-6 shadow-sm sm:flex-row sm:justify-between">
      ...
      {canCreate ? (
        <button
          type="button"
          onClick={onCreate}
          className="bv103-control-h inline-flex items-center gap-2 rounded-lg bg-[#026f17] px-6 text-[10px] font-black uppercase text-[#FFD700] shadow-lg touch-manipulation"
        >
