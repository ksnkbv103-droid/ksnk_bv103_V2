...
export default function BangKiemFormFields({
  ...
  return (
    <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-1">
      ...
      <div className="space-y-2">
        <label className={F.formLabel}>Tên bảng kiểm</label>
        <input
      ...
      <div className="space-y-2">
        <label className={F.formLabel}>Phân loại chuyên môn KSNK</label>
        <select
      ...
      {formData.is_system && (
        <p className="text-[11px] font-semibold text-amber-700 bg-amber-50 rounded-[var(--radius-shell)] px-4 py-3">
