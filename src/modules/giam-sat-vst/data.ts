// src/modules/giam-sat-vst/data.ts
...
export const VST_DASHBOARD_MOMENT_GAP_LABEL = "— Chưa ghi thời điểm trong phiếu" as const;
...
export interface VSTOpportunity {
  ...
  thoi_gian_ghi_nhan?: string; // ISO string
}
