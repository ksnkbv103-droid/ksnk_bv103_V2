    ...
    <div className="space-y-4">
      ...
      {activeTab === 'VI_SINH' && (
        <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3 animate-in fade-in">
          <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">🧫 Nâng cấp bằng chứng vi sinh (BSI & CDC Classification)</span>
      ...
      {activeTab === 'LAM_SANG' && (
        <div className="space-y-4 animate-in fade-in">
          ...
          <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">📸 Chẩn đoán hình ảnh (Mã: BM.LS.PNEU.01)</span>
            ...
            <div className="flex flex-col gap-2">
              ...
              {form.has_chest_imaging_abnormal && (
                <div className="pl-6 flex items-center gap-2 animate-in slide-in-from-top-1">
                  <span className="text-[10px] text-slate-400 font-bold">Ngày thâm nhiễm:</span>
                  <input
                    type="date"
          ...
          <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <span className="text-[10px] font-bold text-slate-400 uppercase block">1. Dấu hiệu toàn thân (Cần &ge; 1)</span>
              ...
              <div>
                <span className="text-[10px] font-bold text-slate-400 uppercase block mb-1">2. Số triệu chứng tại chỗ (Cần &ge; 2)</span>
                <input
                  type="number"
