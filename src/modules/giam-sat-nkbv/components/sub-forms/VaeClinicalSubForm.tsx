    ...
    <div className="space-y-4">
      ...
      {activeTab === 'VI_SINH' && (
        <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3 animate-in fade-in">
          <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">🫁 Khả năng viêm phổi thở máy (PVAP vi sinh)</span>
      ...
      {activeTab === 'LAM_SANG' && (
        <div className="space-y-4 animate-in fade-in">
          ...
          <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">🔌 Thiết bị & Độ tuổi (Máy thở - Mã: BM.LS.VAE.01)</span>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-xl bg-white px-2.5 py-2 text-xs font-semibold focus:ring-1 focus:ring-[#026f17] ${
                    isVaeInvalid ? "border-red-300 focus:border-red-500" : "border-slate-200 focus:border-[#026f17]"
                  }`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border-slate-200 bg-white px-2.5 py-2 text-xs font-semibold focus:border-[#026f17] focus:ring-1 focus:ring-[#026f17]"
                />
              </div>
              <div>
          ...
          {/* VAC Criteria */}
          <div className="bg-slate-50/75 rounded-2xl p-4 border border-slate-100 space-y-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">💨 Biến cố máy thở (VAC)</span>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {form.peep_increase_ge_3 && (
                  <div className="pl-6 flex items-center gap-2 animate-in slide-in-from-top-1">
                    <span className="text-[10px] text-slate-400 font-bold">Ngày tăng:</span>
                    <input
                      type="date"
