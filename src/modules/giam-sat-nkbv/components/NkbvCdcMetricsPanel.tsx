    ...
    <div className="bg-white rounded-3xl border border-slate-150 p-5 space-y-6 shadow-xl shadow-slate-100/50 animate-in fade-in duration-300 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div className="flex items-center gap-2">
          <div className="bg-[#026f17]/10 p-1.5 rounded-xl text-[#026f17]">
            <Activity className="h-4.5 w-4.5" />
          </div>
          <div>
            <span className="text-[10px] font-black uppercase tracking-widest text-[#026f17] block">Surveillance Pipeline</span>
      ...
      <div className="relative border-l-2 border-slate-100 pl-6 ml-3 space-y-5">
        ...
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-emerald-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-emerald-500/20 group-hover:scale-110 transition duration-200">
            1
          </div>
          <div className="space-y-1">
            ...
            <p className="text-[9.5px] leading-relaxed text-slate-500 font-semibold italic">
        ...
        {/* STEP 2: DOE */}
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-indigo-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-indigo-500/20 group-hover:scale-110 transition duration-200">
            2
          </div>
          <div className="space-y-1">
        ...
        {/* STEP 3: RIT */}
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-amber-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-amber-500/20 group-hover:scale-110 transition duration-200">
            3
          </div>
          <div className="space-y-1">
        ...
        {/* STEP 4: POA vs HAI */}
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-blue-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-blue-500/20 group-hover:scale-110 transition duration-200">
            4
          </div>
          <div className="space-y-1">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Bước 4: Thời gian nằm viện & Phân loại</span>
        ...
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-violet-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-violet-500/20 group-hover:scale-110 transition duration-200">
            5
          </div>
          <div className="space-y-1">
            ...
            <div className="bg-indigo-50 border border-indigo-100/70 p-2.5 rounded-2xl space-y-2">
              ...
              {(() => {
                ...
                return (
                  <div className="border-t border-slate-200/50 pt-2 space-y-1 text-[9.5px] font-semibold text-slate-650">
              ...
              <p className="text-[9.5px] leading-relaxed text-indigo-750 font-semibold italic border-t border-slate-200/40 pt-1.5">
        ...
        {checklistType !== "SSI" && (
          <div className="relative group">
            <div className="absolute -left-[33px] top-0.5 bg-pink-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-pink-500/20 group-hover:scale-110 transition duration-200">
              6
            </div>
            <div className="space-y-1">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Bước 6: Quy kết Thiết bị xâm lấn ({device.name})</span>
              <div className={`border p-2.5 rounded-2xl space-y-2 ${
                ...
                {metrics.device_placed_days >= (device.limit + 1) && metrics.device_active_on_event ? (
                  <div className="bg-red-50/75 border border-red-100 rounded-xl p-2 text-[9.5px] text-red-800 font-bold flex items-center gap-1.5 animate-pulse">
                    <AlertCircle className="h-3.5 w-3.5 text-red-650 flex-shrink-0" />
                    Đạt tiêu chí liên quan thiết bị ({device.term})!
                  </div>
                ) : (
                  <div className="bg-emerald-50/75 border border-emerald-100 rounded-xl p-2 text-[9.5px] text-emerald-800 font-bold flex items-center gap-1.5">
        ...
        <div className="relative group">
          <div className="absolute -left-[33px] top-0.5 bg-teal-500 text-white rounded-full h-5.5 w-5.5 flex items-center justify-center text-[10px] font-black shadow-md shadow-teal-500/20 group-hover:scale-110 transition duration-200">
            7
          </div>
          <div className="space-y-1">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Bước 7: Lọc Nhiễm khuẩn thứ phát (Secondary BSI)</span>
            
            {isSecondaryBsi ? (
              <div className="bg-blue-50 border border-blue-200 text-blue-900 rounded-2xl p-3 space-y-1 shadow-sm animate-in slide-in-from-bottom-2">
                <strong className="text-xs font-black text-blue-800 flex items-center gap-1">
                  🎉 SECONDARY BSI MATCHED
                </strong>
                <p className="text-[9.5px] leading-relaxed text-blue-700 font-semibold">
              ...
              <div className="bg-slate-50 border border-slate-150/75 text-slate-650 rounded-2xl p-2.5 text-[9.5px] font-semibold flex items-center gap-1.5">
                <CheckCircle className="h-4 w-4 text-[#026f17] flex-shrink-0" />
