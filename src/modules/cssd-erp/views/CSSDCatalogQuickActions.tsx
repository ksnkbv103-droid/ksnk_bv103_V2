    ...
    <section className="rounded-2xl border border-slate-100 bg-white p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-100 px-3 py-2 text-[10px] font-black uppercase text-emerald-800 disabled:opacity-50"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-sky-100 px-3 py-2 text-[10px] font-black uppercase text-sky-800 disabled:opacity-50"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-amber-100 px-3 py-2 text-[10px] font-black uppercase text-amber-800 disabled:opacity-50"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-rose-100 px-3 py-2 text-[10px] font-black uppercase text-rose-800 disabled:opacity-50"
        >
