      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
        <div className={CSSD_UI_DATA_SURFACE}>
          <div className="px-6 pb-2 pt-6">
            <h3 className="text-[11px] font-medium text-slate-500">Số bộ theo khoa sở hữu danh mục</h3>
          </div>
          <AdvancedDataTable
            columns={[
        ...
        <div className={CSSD_UI_DATA_SURFACE}>
          <div className="px-6 pb-2 pt-6">
            <h3 className="text-[11px] font-medium text-slate-500">Cấp phát theo khoa nhận (SSOT)</h3>
          </div>
          <AdvancedDataTable
            columns={[
        ...
        <div className={CSSD_UI_DATA_SURFACE}>
          <div className="px-6 pb-2 pt-6">
            <h3 className="text-[11px] font-medium text-slate-500">Tái sử dụng &amp; tần suất (top)</h3>
          </div>
          <AdvancedDataTable
            columns={[
              {
...
function EquipmentPanel({ data, loading }: { data: CssdAnalyticsBundle | null; loading: boolean }) {
  return (
    <div className="space-y-4">
      ...
      <div className={CSSD_UI_DATA_SURFACE}>
        <div className="px-6 pb-2 pt-6">
          <h3 className="text-[11px] font-medium text-slate-500">Số lần dùng máy (mẻ trong kỳ)</h3>
        </div>
        <AdvancedDataTable
          columns={[
            {
...
function StaffPanel({ data, loading }: { data: CssdAnalyticsBundle | null; loading: boolean }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={CSSD_UI_DATA_SURFACE}>
        <div className="px-6 pb-2 pt-6">
          <h3 className="text-[11px] font-medium text-slate-500">Quét theo nhân viên</h3>
        </div>
        <AdvancedDataTable
          columns={[
            {
