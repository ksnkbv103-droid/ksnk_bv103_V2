...
export const bv103LayoutChrome = {
  ...
  /** Hủy / từ chối / loại trừ — cùng khung nút chuẩn, viền đỏ (không tự chế bg-red-600). */
  btnDanger:
    "bv103-control-h inline-flex items-center justify-center gap-2 rounded-[var(--radius-control)] border border-red-200 bg-white px-4 text-xs font-semibold text-red-700 shadow-sm transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50",
