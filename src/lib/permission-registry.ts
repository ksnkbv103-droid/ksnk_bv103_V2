...
export const MODULE_TO_GROUP: Record<string, keyof typeof MODULE_GROUPS> = {
  DASHBOARD: "SYSTEM",
  DASHBOARD_CC_OVERVIEW: "SYSTEM",
  DASHBOARD_CC_SUPERVISION: "SYSTEM",
  DASHBOARD_CC_GAP: "SYSTEM",
  DASHBOARD_CC_EXPORT: "SYSTEM",
  DANH_MUC: "SYSTEM",
  DANH_MUC_ORG: "MASTER_DATA",
  DANH_MUC_GSTT: "MASTER_DATA",
  DANH_MUC_CSSD_LOOKUP: "MASTER_DATA",
  NHAN_SU: "SYSTEM",
  BANG_KIEM: "SYSTEM",
  CONG_VIEC: "SYSTEM",
  DAO_TAO: "SYSTEM",
