...
- **Đồng bộ:** token + [`bv103-layout-chrome.ts`](../../src/lib/bv103-layout-chrome.ts) + `npm run layout:drift-check` khi refactor layout; chi tiết [`concepts.md`](../../docs/wiki/concepts.md#layout-primitives).
